        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, bank_1.getBank)(id)];
                case 1:
                    response = _b.sent();
...
var getBanks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, bank_1.getBanks)()];
            case 1:
                response = _a.sent();
                res.send(response);
                return [3 /*break*/, 3];
...
var postBank = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, bank_1.insertBank)(body)];
            case 1:
            ...
            case 2:
                e_3 = _a.sent();
                (0, error_handle_1.handleHttp)(res, "ERROR_POST_BANKS", e_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var updateBank = function (_a, res) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, bank_1.updateBank)(id, body)];
                case 1:
                    response = _b.sent();
                    res.send(response);
                    return [3 /*break*/, 3];
...
var deleteBank = function (_a, res) {
    var params = _a.params;
    return __awaiter(void 0, void 0, void 0, function () {
        var id, response, e_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, bank_1.deleteBank)(id)];
                case 1:
                    response = _b.sent();
                    res.send(response);
                    return [3 /*break*/, 3];
