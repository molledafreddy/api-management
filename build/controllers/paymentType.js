...
var paymentType_1 = require("../services/paymentType");
var error_handle_1 = require("../utils/error.handle");
var getPaymentType = function (_a, res) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, paymentType_1.getPaymentType)(id)];
                case 1:
                    response = _b.sent();
...
var getPaymentTypes = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, e_2;
...
var postPaymentType = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, paymentType_1.insertPaymentType)(body)];
            case 1:
            ...
            case 2:
                e_3 = _a.sent();
                (0, error_handle_1.handleHttp)(res, "ERROR_POST_PAYMENTTYPES", e_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var updatePaymentType = function (_a, res) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, paymentType_1.updatePaymentType)(id, body)];
                case 1:
                    response = _b.sent();
                    res.send(response);
                    return [3 /*break*/, 3];
...
var deletePaymentType = function (_a, res) {
    var params = _a.params;
    return __awaiter(void 0, void 0, void 0, function () {
        var id, response, e_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, paymentType_1.deletePaymentType)(id)];
                case 1:
                    response = _b.sent();
                    res.send(response);
                    return [3 /*break*/, 3];
