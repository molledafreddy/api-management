...
var egress_1 = require("../services/egress");
...
var getOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, egress_1.getOrders)()];
            case 1:
                response = _a.sent();
                res.send(response);
                return [3 /*break*/, 3];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, egress_1.getOrder)(id)];
                case 1:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    id = params.id;
                    return [4 /*yield*/, (0, egress_1.getOrderDetail)(id)];
                case 1:
                    responseItem = _b.sent();
                    res.send(responseItem);
                    return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = req.query;
                return [4 /*yield*/, (0, egress_1.searchOrderPaitOut)(query)];
            case 1:
...
var searchEgress = function (_a, res) {
    var body = _a.body;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, egress_1.searchEgress)(body)];
                case 1:
                    responseItem = _b.sent();
                    // console.log('responseItem', responseItem)
                    res.send(responseItem);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    id = params.id;
                    return [4 /*yield*/, (0, egress_1.validOrderProvider)(id)];
                case 1:
                    responseItem = _b.sent();
                    res.send(responseItem);
                    return [3 /*break*/, 3];
