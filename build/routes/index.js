...
(0, fs_1.readdirSync)(PATH_ROUTER).filter(function (filename) {
    ...
    if (cleanName !== 'index') {
        Promise.resolve().then(function () { return __importStar(require("./".concat(cleanName))); }).then(function (moduleRouter) {
            console.log("Se esta cargando la ruta ...  ".concat(cleanName));
