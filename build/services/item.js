...
var insertCar = function (item) { return __awaiter(void 0, void 0, void 0, function () {
    var responseInsert;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, item_1.default.create(item)];
            case 1:
...
var getCar = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, item_1.default.findOne({ _id: id })];
            case 1:
                responseItem = _a.sent();
                return [2 /*return*/, responseItem];
        }
...
var updateCar = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, item_1.default.findOneAndUpdate({ _id: id }, data, { new: true })];
            case 1:
                responseItem = _a.sent();
                return [2 /*return*/, responseItem];
        }
...
var deleteCar = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, item_1.default.remove({ _id: id })];
            case 1:
                responseItem = _a.sent();
                return [2 /*return*/, responseItem];
        }
